...
| Plan | Price | Env var |
| --- | --- | --- |
| Pro — 3 packs | **$9** one-time | `VITE_STRIPE_PAYMENT_LINK_PRO` |
| Lifetime | **$39** one-time | `VITE_STRIPE_PAYMENT_LINK_LIFETIME` |
...
| Name | Value |
| --- | --- |
| `VITE_PAYMENTS_MODE` | `live` (or `test` while testing) |
| `VITE_STRIPE_PAYMENT_LINK_PRO` | `https://buy.stripe.com/...` ($9) |
| `VITE_STRIPE_PAYMENT_LINK_LIFETIME` | `https://buy.stripe.com/...` ($39) |
