...
const APP_NAME = "LandIt AI";
const host = import.meta.env.VITE_PUBLIC_HOSTNAME;
const ogImage = host
  ? `https://og.grok.me/v1/card.png?host=${encodeURIComponent(host)}&title=${encodeURIComponent(APP_NAME)}&subtitle=${encodeURIComponent("Land more interviews, faster")}`
  : undefined;
